"""Live-stack horizon migration above 019_subworkflow_handoff_live.

Revision ID: 020_horizon_prereq_corr_live
Revises: 019_subworkflow_handoff_live
"""
...
revision = "020_horizon_prereq_corr_live"
down_revision = "019_subworkflow_handoff_live"
branch_labels = None
depends_on = None
...
def _assert_apply_target() -> None:
    ...
    if name.startswith("td_test_") or name == "top_delivery_control_p1":
        return
    raise RuntimeError(
        "020_horizon_prereq_corr_live may apply only on disposable td_test_* clones or live top_delivery_control_p1"
    )
