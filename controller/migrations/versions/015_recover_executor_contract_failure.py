...
Revision ID: 015_recover_executor_contract_failure
Revises: 014_requeue_blocked_parent_task

Candidate migration landed onto this worktree versions/ path so Alembic can
resolve 017 atop 016. Upgrade still refuses non-td_test_* databases. Do not
apply to live top_delivery_control_p1 from the 017 remediation envelope.
"""
...
revision = "015_recover_executor_contract_failure"
down_revision = "014_requeue_blocked_parent_task"
branch_labels = None
depends_on = None

SQL_DIR = Path(__file__).resolve().parents[2] / "sql"
UPGRADE_SQL = (SQL_DIR / "015_recover_executor_contract_failure.sql").read_text()
DOWNGRADE_SQL = (SQL_DIR / "015_downgrade_restore_014_scope.sql").read_text()
