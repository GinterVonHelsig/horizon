"""Live-stack horizon migration above 017_parent_rollback_routine.

Revision ID: 018_horizon_project_ledger_live
Revises: 017_parent_rollback_routine
"""
...
revision = "018_horizon_project_ledger_live"
down_revision = "017_parent_rollback_routine"
branch_labels = None
depends_on = None
...
def _assert_apply_target() -> None:
    ...
    if name.startswith("td_test_") or name == "top_delivery_control_p1":
        return
    raise RuntimeError(
        "018_horizon_project_ledger_live may apply only on disposable td_test_* clones or live top_delivery_control_p1"
    )
